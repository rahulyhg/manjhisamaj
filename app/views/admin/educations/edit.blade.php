    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <div class="col-lg-6">
                    {{ Form::model($data, array( 'route' => array('admin.educations.update', $id), 'method' => 'patch' , 'id' => 'frm_caste', 'class' => 'form-horizontal') ) }}
                        ...
                        <div class="form-group">
                            ...
                            {{ Form::select('education_category_id', $results , $data->education_category_id , array("class" => 'form-control') ) }}
                            <p class="help-inline">
