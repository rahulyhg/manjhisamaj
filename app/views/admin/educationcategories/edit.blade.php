    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <div class="col-lg-6">
                    {{ Form::model($data, array( 'route' => array('admin.educationcategories.update', $id), 'method' => 'patch' , 'id' => 'frm_caste', 'class' => 'form-horizontal') ) }}
                        ...
                        <a href="{{ URL::action('EducationCategoryController@index') }}" class="btn btn-danger">
                            Cancel
                        </a>
