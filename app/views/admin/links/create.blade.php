    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <div class="col-lg-6">
                    {{ Form::open(array('route' => 'admin.links.store', 'method'=> 'post', 'role'=> 'form', 'id' => 'frm_caste', 'class' => 'form-horizontal')) }}
                        ...
                        <div class="form-group">
                            ...
                            {{ Form::select('link_category_id', $results , '', array("class" => 'form-control') ) }}
                            <p class="help-inline">
