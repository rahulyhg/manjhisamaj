    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <div class="col-lg-6">
                    {{ Form::model($data, array( 'route' => array('admin.suggestions.update', $id), 'method' => 'patch' , 'id' => 'frm_caste', 'class' => 'form-horizontal') ) }}
                        ...
                        <div class="form-group">
                            ...
                            {{ Form::select('is_approved', $approval_array , $data->is_approved, array("class" => 'form-control') ) }}
                            <p class="help-inline">
