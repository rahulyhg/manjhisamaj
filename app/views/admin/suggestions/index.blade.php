        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    ...
                    <a href="{{ URL::action('SuggestionController@create') }}" class="btn btn-primary ">
                ...
                <div class="panel-body">
				    ...
				    <th>Approval</th>
					    ...
					    <td>{{ ($result->is_approved == 1) ? 'Yes' : 'No' }}</td>
                                            ...
                                            <td class="action">
                                                <a href="{{ URL::action('SuggestionController@show', $result->id ) }}" class="btn btn-success btn-circle">
						    <span class="fa fa-eye"></span>
						</a>
                                                    
                                                <a href="{{ URL::action('SuggestionController@edit', $result->id ) }}" class="btn btn-primary btn-circle">
						    <span class="fa fa-edit"></span>
						</a>
                                                    
                                                {{ Form::open(array('route' => array('admin.suggestions.destroy', $result->id), 'method' => 'delete', 'style' => 'display:inline-block' , 'id' => 'frm_delete' )) }}
